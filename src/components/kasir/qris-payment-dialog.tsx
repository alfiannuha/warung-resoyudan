    ...
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent className="max-h-[90dvh] max-w-[400px] overflow-y-auto">
        <DialogHeader className="items-center text-center">
          ...
          <DialogTitle className="text-headline-md font-bold">Pembayaran QRIS</DialogTitle>
        ...
        <div className="space-y-2.5">
          <button
            onClick={onConfirm}
            className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-md bg-success font-semibold text-white transition-all active:scale-[0.98]"
          >
          ...
          <button
            onClick={onClose}
            className="inline-flex h-12 w-full items-center justify-center gap-2 rounded-md bg-warning font-semibold text-white transition-all active:scale-[0.98]"
          >
            Belum Dibayar
          </button>
        </div>
